...
class Message(base.TelegramObject):
    ...
    async def answer_chat_action(
        ...
        """
        Use this method when you need to tell the user that something is happening on the mybot's side.
        The status is set for 5 seconds or less
        (when a message arrives from your mybot, Telegram clients clear its typing status).

        We only recommend using this method when a response from the mybot will take
    ...
    async def edit_caption(
        ...
        """
        Use this method to edit captions of messages sent by the mybot or via the mybot
        (for inline bots).
        ...
        :return: On success, if edited message is sent by the mybot, the edited Message
    ...
    async def delete_reply_markup(self) -> typing.Union[Message, base.Boolean]:
        """
        Use this method to delete reply markup of messages sent by the mybot or via the mybot (for inline bots).
