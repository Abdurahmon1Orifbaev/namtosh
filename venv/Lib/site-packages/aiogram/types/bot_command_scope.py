...
class BotCommandScope(base.TelegramObject):
    """
    This object represents the scope to which mybot commands are applied.
...
class BotCommandScopeDefault(BotCommandScope):
    """
    Represents the default scope of mybot commands.
...
class BotCommandScopeAllPrivateChats(BotCommandScope):
    """
    Represents the scope of mybot commands, covering all private chats.
    """
...
class BotCommandScopeAllGroupChats(BotCommandScope):
    """
    Represents the scope of mybot commands, covering all group and
    supergroup chats.
    """
...
class BotCommandScopeChat(BotCommandScope):
    """
    Represents the scope of mybot commands, covering a specific chat.
    """
...
class BotCommandScopeChatAdministrators(BotCommandScopeChat):
    """
    Represents the scope of mybot commands, covering all administrators
...
class BotCommandScopeChatMember(BotCommandScopeChat):
    """
    Represents the scope of mybot commands, covering a specific member of
