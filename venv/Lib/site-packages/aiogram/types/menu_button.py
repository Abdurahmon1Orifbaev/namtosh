...
class MenuButton(base.TelegramObject):
    """
    This object describes the mybot's menu button in a private chat. It should be one of
    ...
    By default, the menu button opens the list of mybot commands.
    """
...
class MenuButtonCommands(MenuButton):
    """
    Represents a menu button, which opens the mybot's list of commands.
