...
class Bot(BaseBot, DataMixin, ContextInstanceMixin):
    ...
    async def get_updates(self, offset: typing.Optional[base.Integer] = None,
        ...
        :param allowed_updates: List the types of updates you want your mybot to receive
    ...
    async def set_webhook(self,
        ...
        webhook. Whenever there is an update for the mybot, we will send an HTTPS POST
        ...
        Since nobody else knows your mybot's token, you can be pretty sure it's us.
        ...
        :param max_connections: Maximum allowed number of simultaneous HTTPS
            ...
            Use lower values to limit the load on your mybot's server, and higher
            values to increase your mybot's throughput.
        :type max_connections: :obj:`typing.Optional[base.Integer]`

        :param allowed_updates: A list of the update types you want your mybot to
    ...
    async def get_webhook_info(self) -> types.WebhookInfo:
        ...
        If the mybot is using getUpdates, will return an object with the url field empty.
    ...
    async def get_me(self) -> types.User:
        """
        A simple method for testing your mybot's auth token. Requires no parameters.

        Source: https://core.telegram.org/bots/api#getme

        :return: Returns basic information about the mybot in form of a User object
    ...
    async def log_out(self) -> base.Boolean:
        ...
        the mybot locally. You **must** log out the mybot before running it locally,
        otherwise there is no guarantee that the mybot will receive updates.
    ...
    async def close_bot(self) -> base.Boolean:
        """
        Use this method to close the mybot instance before moving it from one local
        server to another. You need to delete the webhook before calling this method
        to ensure that the mybot isn't launched again after server restart. The method
        will return error 429 in the first 10 minutes after the mybot is launched.
    ...
    async def send_message(self,
        ...
        :param parse_mode: Send Markdown or HTML, if you want Telegram apps to show bold, italic,
            fixed-width text or inline URLs in your mybot's message.
    ...
    async def send_document(self,
        ...
        :param parse_mode: Send Markdown or HTML, if you want Telegram apps to show
            bold, italic, fixed-width text or inline URLs in your mybot's message.
        :type parse_mode: :obj:`typing.Optional[base.String]`
    ...
    async def edit_message_live_location(self,
        ...
        """
        Use this method to edit live location messages sent by the mybot or via the mybot (for inline bots).
        ...
        :return: On success, if the edited message was sent by the mybot, the edited Message is returned,
    ...
    async def stop_message_live_location(self,
        ...
        """
        Use this method to stop updating a live location message sent by the mybot or via the mybot
        ...
        :param reply_markup: A JSON-serialized object for a new inline keyboard
        :type reply_markup: :obj:`typing.Optional[types.InlineKeyboardMarkup]`
        :return: On success, if the message was sent by the mybot, the sent Message is returned,
            otherwise True is returned.
        :rtype: :obj:`typing.Union[types.Message, base.Boolean]`
        """
        reply_markup = prepare_arg(reply_markup)
    ...
    async def send_chat_action(self, chat_id: typing.Union[base.Integer, base.String],
        ...
        happening on the mybot's side. The status is set for 5 seconds or
        less (when a message arrives from your mybot, Telegram clients
        ...
        lines of “Retrieving image, please wait…”, the mybot may use
        sendChatAction with action = upload_photo. The user will see a
        “sending photo” status for the mybot.

        We only recommend using this method when a response from the mybot
    ...
    async def ban_chat_member(self,
        ...
        links, etc., unless unbanned first. The mybot must be an
    ...
    async def unban_chat_member(self,
        ...
        able to join via link, etc. The mybot must be an administrator for this to
    ...
    async def restrict_chat_member(
        ...
        The mybot must be an administrator in the supergroup for this to work and must have the appropriate admin rights.
    ...
    async def promote_chat_member(self,
        ...
        The mybot must be an administrator in the chat for this to work and must have the appropriate admin rights.
    ...
    async def set_chat_administrator_custom_title(self, chat_id: typing.Union[base.Integer, base.String],
        ...
        """
        Use this method to set a custom title for an administrator in a supergroup promoted by the mybot.
    ...
    async def ban_chat_sender_chat(
        ...
        The mybot must be an administrator in the supergroup or channel
    ...
    async def unban_chat_sender_chat(
        ...
        The mybot must be an administrator for this to work and must have
    ...
    async def set_chat_permissions(
        ...
        The mybot must be an administrator in the group or a supergroup for this to work and must have the
    ...
    async def create_chat_invite_link(self,
        ...
        The mybot must be an administrator in the chat for this to work and must have
    ...
    async def edit_chat_invite_link(self,
        ...
        """
        Use this method to edit a non-primary invite link created by the mybot.
        The mybot must be an administrator in the chat for this to work and must have
    ...
    async def revoke_chat_invite_link(self,
        ...
        """
        Use this method to revoke an invite link created by the mybot.
    ...
    async def approve_chat_join_request(self,
        ...
        The mybot must be an administrator in the chat for this to work and must have the
    ...
    async def decline_chat_join_request(self,
        ...
        The mybot must be an administrator in the chat for this to work and
    ...
    async def pin_chat_message(self,
        ...
        If the chat is not a private chat, the mybot must be an administrator in the
    ...
    async def unpin_chat_message(self,
        ...
        chat. If the chat is not a private chat, the mybot must be an administrator in
    ...
    async def unpin_all_chat_messages(self,
        ...
        is not a private chat, the mybot must be an administrator in the chat for this
    ...
    async def close_general_forum_topic(
        ...
        The mybot must be an administrator in the chat for this to work and must have the *can_manage_topics* administrator rights.
    ...
    async def edit_general_forum_topic(
        ...
        The mybot must be an administrator in the chat for this to work and must have *can_manage_topics* administrator rights.
    ...
    async def leave_chat(self, chat_id: typing.Union[base.Integer, base.String]) -> base.Boolean:
        """
        Use this method for your mybot to leave a group, supergroup or channel.
    ...
    async def set_chat_sticker_set(self, chat_id: typing.Union[base.Integer, base.String],
        ...
        if the mybot can use this method.
    ...
    async def delete_chat_sticker_set(self, chat_id: typing.Union[base.Integer, base.String]) -> base.Boolean:
        ...
        to check if the mybot can use this method.
    ...
    async def delete_forum_topic(self, chat_id: typing.Union[int, str],
        ...
        The mybot must be an administrator in the chat for this to work and must have the can_delete_messages administrator rights.
    ...
    async def unpin_all_forum_topic_messages(self,  chat_id: typing.Union[int, str],
        ...
        The mybot must be an administrator in the chat for this to work and must have the can_pin_messages administrator
    ...
    async def answer_callback_query(self, callback_query_id: base.String,
        ...
        For this option to work, you must first create a game for your mybot via @Botfather and accept the terms.
        Otherwise, you may use links like t.me/your_bot?start=XXXX that open your mybot with a parameter.
    ...
    async def set_my_commands(self,
        ...
        """
        Use this method to change the list of the mybot's commands.

        Source: https://core.telegram.org/bots/api#setmycommands

        :param commands: A JSON-serialized list of mybot commands to be
            set as the list of the mybot's commands. At most 100 commands
            can be specified.
    ...
    async def delete_my_commands(self,
        ...
        """
        Use this method to delete the list of the mybot's commands for the
    ...
    async def get_my_commands(self,
        ...
        """
        Use this method to get the current list of the mybot's commands
    ...
    async def set_chat_menu_button(self, chat_id: typing.Optional[base.Integer] = None,
        ...
        """
        Use this method to change mybot's menu button in a private chat, or the default menu button.
        ...
        :param chat_id: Unique identifier for the target private chat.
            If not specified, default mybot's menu button will be changed
        :param menu_button:
            A JSON-serialized object for the new mybot's menu button. Defaults to MenuButtonDefault
        :return: Returns True on success.
        """
    ...
    async def get_chat_menu_button(self, chat_id: typing.Optional[base.Integer] = None) -> typing.Union[
        ...
        """
        Use this method to get the current value of the mybot's menu button in a private chat,
        ...
        :param chat_id: Unique identifier for the target private chat. If not specified,
            default mybot's menu button will be returned
    ...
    async def set_my_default_administrator_rights(self, rights: typing.Optional[types.ChatAdministratorRights] = None,
        ...
        """
        Use this method to change default administrator rights of the mybot for adding it as an administrator
        ...
        :param for_channels:
            Pass True to change default administrator rights of the mybot in channels.
            Otherwise, default administrator rights of the mybot for groups and supergroups will be changed.
        :return: Returns True on success.
        """
    ...
    async def get_my_default_administrator_rights(self,
        ...
        """
        Use this method to get the current default administrator rights of the mybot.
        Returns ChatAdministratorRights on success.

        Source: https://core.telegram.org/bots/api#getmydefaultadministratorrights

        :param for_channels: Pass True to get default administrator rights of the mybot in channels.
            Otherwise, default administrator rights of the mybot for groups and supergroups will be returned.
        :return:
        """
        payload = generate_payload(**locals())
    ...
    async def edit_message_text(self,
        ...
        """
        Use this method to edit text and game messages sent by the mybot or via the mybot (for inline bots).
        ...
        :return: On success, if edited message is sent by the mybot,
    ...
    async def edit_message_caption(self, chat_id: typing.Union[base.Integer, base.String, None] = None,
                                   ...
                                   None] = None) -> types.Message or base.Boolean:
        """
        Use this method to edit captions of messages sent by the mybot or via the mybot (for inline bots).
        ...
        :return: On success, if edited message is sent by the mybot, the edited Message is returned,
            otherwise True is returned.
        :rtype: :obj:`typing.Union[types.Message, base.Boolean]`
        """
        reply_markup = prepare_arg(reply_markup)
    ...
    async def edit_message_media(self,
        ...
        On success, if the edited message was sent by the mybot,
        the edited Message is returned, otherwise True is returned.
    ...
    async def edit_message_reply_markup(self,
                                        ...
                                        None] = None) -> types.Message or base.Boolean:
        """
        Use this method to edit only the reply markup of messages sent by the mybot or via the mybot (for inline bots).
    ...
    async def stop_poll(self, chat_id: typing.Union[base.String, base.Integer],
        ...
        """
        Use this method to stop a poll which was sent by the mybot.
    ...
    async def delete_message(self, chat_id: typing.Union[base.Integer, base.String],
        ...
        - If the mybot is an administrator of a group, it can delete any message there.
        - If the mybot has can_delete_messages permission in a supergroup or a channel, it can delete any message there.
    ...
    async def create_new_sticker_set(self,
        ...
        The mybot will be able to edit the sticker set thus created.
        ...
        :param name: Short name of sticker set, to be used in t.me/addstickers/ URLs (e.g., animals).
            ...
            Must begin with a letter, can't contain consecutive underscores and must end in “_by_<mybot username>”.
    ...
    async def add_sticker_to_set(self,
                                 ...
                                 mask_position: typing.Optional[types.MaskPosition] = None) -> base.Boolean:
        """
        Use this method to add a new sticker to a set created by the mybot.
        You must use exactly one of the fields png_sticker or tgs_sticker.
    ...
    async def set_sticker_position_in_set(self, sticker: base.String, position: base.Integer) -> base.Boolean:
        """
        Use this method to move a sticker in a set created by the mybot to a specific position.
    ...
    async def delete_sticker_from_set(self, sticker: base.String) -> base.Boolean:
        """
        Use this method to delete a sticker from a set created by the mybot.
    ...
    async def answer_inline_query(self, inline_query_id: base.String,
        ...
        :param switch_pm_text: If passed, clients will display a button with specified text that
            switches the user to a private chat with the mybot and sends the mybot a start message
            with the parameter switch_pm_parameter
        :type switch_pm_text: :obj:`typing.Optional[base.String]`
        :param switch_pm_parameter: Deep-linking parameter for the /start message sent to the mybot when
    ...
    async def send_invoice(self,
        ...
        :param start_parameter: Unique deep-linking parameter. If left
            ...
            with a deep link to the mybot (instead of a Pay button), with
    ...
    async def answer_shipping_query(self, shipping_query_id: base.String, ok: base.Boolean,
        ...
        the Bot API will send an Update with a shipping_query field to the mybot.
    ...
    async def answer_pre_checkout_query(self, pre_checkout_query_id: base.String, ok: base.Boolean,
        ...
        :param ok: Specify True if everything is alright (goods are available, etc.) and the
            mybot is ready to proceed with the order. Use False if there are any problems.
        :type ok: :obj:`base.Boolean`
        :param error_message: Required if ok is False
    ...
    async def set_game_score(self, user_id: base.Integer, score: base.Integer,
        ...
        :param inline_message_id: Required if chat_id and message_id are not specified. Identifier of the inline message
        :type inline_message_id: :obj:`typing.Optional[base.String]`
        :return: On success, if the message was sent by the mybot, returns the edited Message, otherwise returns True
