...
class WebhookRequestHandler(web.View):
    ...
    async def parse_update(self, bot):
        ...
        :param bot: mybot instance. You an get it from Dispatcher
...
class SendMessage(BaseResponse, ReplyToMixin, ParseModeMixin,
    ...
    def __init__(self, chat_id: Union[Integer, String] = None,
        ...
        :param parse_mode: String (Optional) - Send Markdown or HTML, if you want Telegram apps to show bold,
            italic, fixed-width text or inline URLs in your mybot's message.
...
class CreateNewStickerSet(BaseResponse):
    ...
    def __init__(self, user_id: Integer,
        ...
        :param name: String - Short name of sticker set, to be used in t.me/addstickers/ URLs (e.g., animals).
            ...
            can't contain consecutive underscores and must end in “_by_<mybot username>”. <bot_username>
...
class AnswerInlineQuery(BaseResponse):
    ...
    def __init__(self, inline_query_id: String,
        ...
        :param switch_pm_text: String (Optional) - If passed, clients will display a button with specified text
            that switches the user to a private chat with the mybot and sends the mybot a start
        ...
        :param switch_pm_parameter: String (Optional) - Deep-linking parameter for the /start message
            sent to the mybot when user presses the switch button. 1-64 characters,
            only A-Z, a-z, 0-9, _ and - are allowed.
            Example: An inline mybot that sends YouTube videos can ask the user to connect the mybot to their
            ...
            The user presses the button, switches to a private chat with the mybot and,
            in doing so, passes a start parameter that instructs the mybot to return an oauth link.
            Once done, the mybot can offer a switch_inline button so that the user can easily return
            to the chat where they wanted to use the mybot's inline capabilities.
        """
...
class AnswerPreCheckoutQuery(BaseResponse):
    ...
    def __init__(self, pre_checkout_query_id: String,
        ...
        :param ok: Boolean - Specify True if everything is alright (goods are available, etc.)
            and the mybot is ready to proceed with the order. Use False if there are any problems.
        :param error_message: String (Optional) - Required if ok is False.
